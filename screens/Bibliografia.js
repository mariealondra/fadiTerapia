  ...
  return (
    <View style={Global.globalPadding}>
      ...
      <Text
        style={{ color: "blue" }}
        onPress={() =>
          Linking.openURL("https://www.youtube.com/watch?v=8PcHtClQWyI&t=6s")
        }
      >
        {" "}
        VIDEOS DE ASK DOCTOR JO.
      </Text>
      <Text> </Text>
      <Text
        style={{ color: "blue" }}
        onPress={() =>
          Linking.openURL(
            "https://www.youtube.com/playlist?list=PLgWeSW4QJyQ9mb_YmOHlMs3cWm1ZfJW8u"
          )
        }
      >
        {" "}
        VIDEOS DE Konstanty Kulik.
      </Text>
      <Text> </Text>
      <Text
        style={{ color: "blue" }}
        onPress={() =>
          Linking.openURL("https://www.youtube.com/watch?v=stVYJwJShW4&t=141s")
        }
      >
        {" "}
        VIDEOS DE HOSPITAL RIBERA POVISA.
      </Text>
      <Text> </Text>
      <Text> </Text>
      <Text> </Text>
